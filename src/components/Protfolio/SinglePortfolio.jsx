...
const SinglePortfolio = ({ data, getData }) => {
  ...
  return (
    <div className="col-lg-4 col-md-6  w-48 h-48 " data-aos={effect} data-aos-duration={duration} data-aos-delay={delay}>
        ...
        <div className="st-portfolio-item">
          <div className="st-portfolio st-zoom">
            <div className="st-portfolio-img st-zoom-in">
              <img src={imgLink} className='project-image' alt="portfolio" />
            </div>
